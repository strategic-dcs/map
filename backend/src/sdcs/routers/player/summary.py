...
@router.get("/{campaign_id}/summary", response_model=list[PlayerSummary], summary="Returns player summary for a given campaign_id")
...
@router.get("/summary", response_model=list[PlayerSummary], summary="Returns player summary of all time")
