...
@router.get("/players", response_model=list[PlayerSummary], summary="Returns player summary")
def get_players_in_campaign(campaign_id: int = None, db: Session = Depends(get_db)):
